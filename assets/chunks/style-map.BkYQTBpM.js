import{c as C,e as k,i as $,x,r as I,T as B}from"./lit-element.DlPO3IHk.js";import{d as O,_ as R,f as E,g as T,e as H,r as q,l as U,a as F,p as D,q as G,t as L}from"./chunk.3EPZX5HE.BXys8FbU.js";import{n as f,t as N}from"./context.DjmyCDNo.js";import"./display-error.ILZb7JAF.js";function W(e){return{attribute:e,type:Object,hasChanged:(t,s)=>(t==null?void 0:t.toString())!==(s==null?void 0:s.toString()),converter:{fromAttribute:t=>t&&t.length>0&&C(t),toAttribute:t=>t&&k(t)},reflect:!0}}function ot(e){return{attribute:e,type:Object,hasChanged:(t,s)=>(t==null?void 0:t.toString())!==(s==null?void 0:s.toString()),converter:{fromAttribute:t=>t?t.split(",").map(C):[],toAttribute:t=>t&&t.map(k).join(",")},reflect:!0}}var Z=$`
  :host {
