import{i as _,x as d,r as I}from"./lit-element.Boh-YGZU.js";import{n,S as H,p as A,t as E}from"./context.CPoyaPMH.js";import{w as P,j as z,k as O,d as w,_ as o,e as y,r as j,n as C,o as x,f as T,L as D,p as v,q as f,u as g,v as b,g as m,m as p,s as L,c as F,l as q}from"./routes.CkF5Gd-V.js";import{S as B}from"./chunk.3HB7VQL2.C4SyEhET.js";import{H as k}from"./edit-profile.CTjv6iP4.js";import"./range.CRHiLbae.js";import"./commonjsHelpers.D6yTTuv9.js";import"./toFinite.CFYyTVp8.js";import"./isSymbol.DnU6SLKZ.js";import"./static.ckAnSLD9.js";import"./if-defined.C5wmbpVq.js";function U(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function M(e,t="primary",i=z,s=3e3){const a=Object.assign(document.createElement("sl-alert"),{variant:t,closable:!0,duration:s,innerHTML:`
        <sl-icon src="${P(i)}" slot="icon"></sl-icon>
        ${U(e)}
    ...
    `}};S.styles=[w,X];S.define("sl-card");var G=Object.defineProperty,J=Object.getOwnPropertyDescriptor,$=(e,t,i,s)=>{for(var a=s>1?void 0:s?J(t,i):t,h=e.length-1,u;h>=0;h--)(u=e[h])&&(a=(s?u(t,i,a):u(a))||a);return s&&a&&G(t,i,a),a};let c=class extends H(I){async createProfile(e){try{await this.store.client.createProfile(e),this.dispatchEvent(new CustomEvent("profile-created",{detail:{profile:e},bubbles:!0,composed:!0}))}catch(t){console.error(t),N(p("Error creating the profile"))}}render(){return d`
      <sl-card>
        <div class="column">
          ...
          ></edit-profile></div
      ></sl-card>
    `}};c.styles=L;$([F({context:A,subscribe:!0}),n()],c.prototype,"store",2);c=$([q(),E("create-profile")],c);export{c as CreateProfile};
