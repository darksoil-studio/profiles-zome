import{_ as v}from"./tslib.es6.kHcLnhpD.js";import{n as h,c as W,t as Y,S as F,s as V}from"./property.DW58LSP5.js";import{f as _,_ as l,e as m,j as w,k as O,g as E,L as R,q as $,n as T,o as L,p as D,h as I,i as B,A as q,t as j,d as X,S as Q,l as G,a as x}from"./chunk.AJ3ENQ5C.CWahIKAi.js";import{A as C,S as z,j as J,i as k,x as c,E as P,r as Z}from"./lit-element.BYH7MJbe.js";import{S as N}from"./display-error.euNRL-7Q.js";import{o as U}from"./if-defined.mwbAsAHa.js";import{S as ee,H as te,g as se}from"./chunk.AYM4DUFB.s4vIXNqq.js";import"./holo-identicon.TaizM_pS.js";import{p as ie}from"./context.Bem5hB17.js";import"./agent-avatar.BmnWbJVl.js";import"./profile-list-item-skeleton.C1XO0VII.js";function ne(e){return e!=null&&typeof e=="object"&&"then"in e&&typeof e.then=="function"}function oe(e,t,s){const i=new z.Computed(()=>{const a=[e,...s].map(u=>u.get());let o=a[0];if(o&&o.status){if(o.status==="error")return o;if(o.status==="pending")return o;o=o.value}try{return t(o,...a.slice(1).map(f=>f.value).reverse())}catch(u){return{status:"error",error:u}}});let n;const r=new C(()=>{const a=e.get();return n=void 0,a});return new C(()=>{r.get();const a=i.get();if(a&&a.get&&!a.has){const o=a.get();return o&&o.status?o:{status:"completed",value:o}}else if(ne(a)){n||(n=J(()=>a));const o=n.get();return o.status==="completed"&&o.value.status?o.value:o}else return a&&a.status?a:{status:"completed",value:a}})}function re(e,t,s,i,n,r,a){let o=e;const u=o.get();return(!u||!(typeof u=="object"&&"status"in u))&&(o=new C(()=>({status:"completed",value:e.get()}))),oe(o,t,[])}var ae=k`
  :host {
