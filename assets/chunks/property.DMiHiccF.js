var p=Object.defineProperty;var u=(t,e,s)=>e in t?p(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var d=(t,e,s)=>u(t,typeof e!="symbol"?e+"":e,s);import{S as l,u as h,f}from"../elements_profile-prompt.md.BOO7epWE.js";/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let _=class extends Event{constructor(e,s,o){super("context-request",{bubbles:!0,composed:!0}),this.context=e,this.callback=s,this.subscribe=o??!1}};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function v(t){return t}const y="hc_zome_profiles/store";/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function C(t){class e extends t{constructor(){super(...arguments);d(this,"__dispose");d(this,"w",new l.subtle.Watcher(()=>{this.requestUpdate()}))}performUpdate(){if(this.isUpdatePending===!1)return;const n=this.__dispose,r=new l.Computed(()=>{super.performUpdate()});this.w.watch(r),this.__dispose=()=>{this.w.unwatch(r)},r.get(),n==null||n()}connectedCallback(){super.connectedCallback(),this.requestUpdate()}disconnectedCallback(){var n;super.disconnectedCallback(),(n=this.__dispose)==null||n.call(this)}}return e}/**
 * @license
