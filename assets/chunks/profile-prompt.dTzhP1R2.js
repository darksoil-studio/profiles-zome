import{a as _,n as h,t as y,S as L,p as C}from"./context.CPoyaPMH.js";import{i as f,r as g,x as a,e as R,g as q,H as E}from"./lit-element.Boh-YGZU.js";import{_ as c}from"./tslib.es6.kHcLnhpD.js";import{j as B,k as T,c as k,r as x,m as r,w as A,s as j,l as z,x as I}from"./routes.CkF5Gd-V.js";import"./create-profile.Euicj7jX.js";import"./chunk.3HB7VQL2.C4SyEhET.js";import"./edit-profile.CTjv6iP4.js";import"./chunk.EHUQAWJK.4jNy8QLF.js";import"./display-error.BU3R3_jK.js";import"./range.CRHiLbae.js";import"./commonjsHelpers.D6yTTuv9.js";import"./toFinite.CFYyTVp8.js";import"./isSymbol.DnU6SLKZ.js";import"./static.ckAnSLD9.js";import"./if-defined.C5wmbpVq.js";const $=_("linked_devices/store"),S=60*1e3,D=[f`
    .row {
      display: flex;
      flex-direction: row;
    }
		...
		`];c([k({context:$,subscribe:!0}),h()],u.prototype,"store",void 0);c([x()],u.prototype,"successfulRecipient",void 0);u=c([y("link-devices-requestor")],u);var U=Object.defineProperty,F=Object.getOwnPropertyDescriptor,b=(s,e,t,n)=>{for(var i=n>1?void 0:n?F(e,t):e,o=s.length-1,l;o>=0;o--)(l=s[o])&&(i=(n?l(e,t,i):l(i))||i);return n&&i&&U(e,t,i),i};let d=class extends L(g){constructor(){super(...arguments),this.view="question"}renderContent(){return this.linkedDevicesStore?this.view==="create-profile"?a`
			...
			`:this.view==="link-device"?a` <div class="column" style="align-items: start">
				<sl-button
					...
					style="margin-bottom: 12px"
				>
					<sl-icon slot="prefix" .src=${A(I)}></sl-icon>
					${r("Back")}</sl-button
				>
