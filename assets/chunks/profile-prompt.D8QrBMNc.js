import{b as S,s as m,n as h,t as y,c as g,S as P,p as B}from"./context.C3X5h_YG.js";import{i as k,r as L,x as c,e as $,f as R,g as q}from"./lit-element.5UXQ_LNh.js";import{_ as a}from"./tslib.es6.kHcLnhpD.js";import{r as b,m as n,w as A,l as C,h as E}from"./chunk.3EPZX5HE.C5DcSmWt.js";import"./create-profile.Cg2NwLen.js";import"./chunk.3HB7VQL2.C3Njm4zI.js";import{a as I,n as D}from"./edit-profile.D0flNjGr.js";import"./chunk.5KGB34TL.DAqnK4Te.js";import"./chunk.EHUQAWJK.CXaVkoM5.js";import"./display-error.2dck76_Y.js";import"./range.CRHiLbae.js";import"./commonjsHelpers.D6yTTuv9.js";import"./toFinite.CFYyTVp8.js";import"./isSymbol.DnU6SLKZ.js";import"./static.C1tkqjMX.js";import"./if-defined.DjkTvaUx.js";const x=S("linked_devices/store"),_=60*1e3;let v=class extends L{constructor(){super(...arguments),this.passcodeLength=4}firstUpdated(){setTimeout(()=>{var e;(e=this.shadowRoot.getElementById("input-0"))===null||e===void 0||e.focus()})}get passcode(){const e=Array.from(this.shadowRoot.querySelectorAll("sl-input")),t=Array.from(Array(this.passcodeLength)).map(()=>{});for(let i=0;i<e.length;i++){if(e[i].value==="")return;const s=parseInt(e[i].value,10);if(s>9)return;t[i]=s}return t}clearPasscode(){Array.from(this.shadowRoot.querySelectorAll("sl-input")).forEach(t=>t.value=""),setTimeout(()=>{var t;(t=this.shadowRoot.getElementById("input-0"))===null||t===void 0||t.focus()})}maybeDispatchEvent(){const e=this.passcode;e&&this.dispatchEvent(new CustomEvent("passcode-change",{bubbles:!0,composed:!0,detail:{passcode:e}}))}render(){return c`
			<div class="row">
