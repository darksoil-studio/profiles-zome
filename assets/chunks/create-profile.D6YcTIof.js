import{i as _,x as d,r as I}from"./lit-element.DlPO3IHk.js";import{n,S as H,s as A,c as P,p as z,t as E}from"./context.DjmyCDNo.js";import{w as O,o as j,p as D,d as w,_ as o,e as y,r as L,k as C,q as x,f as T,L as F,u as v,v as f,x as g,y as b,g as m,a as p,l as q}from"./chunk.3EPZX5HE.Di75AIhZ.js";import{S as B}from"./chunk.3HB7VQL2.uJwZWAdR.js";import{H as S}from"./chunk.5KGB34TL.BQU-5FUs.js";import"./edit-profile.DFArlDSL.js";function M(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function U(e,t="primary",i=j,s=3e3){const a=Object.assign(document.createElement("sl-alert"),{variant:t,closable:!0,duration:s,innerHTML:`
        <sl-icon src="${O(i)}" slot="icon"></sl-icon>
        ${M(e)}
      `});return document.body.append(a),a.toast()}function N(e){return U(e,"danger",D)}var W=_`
  :host {
    display: contents;
...
`,l=Object.assign(document.createElement("div"),{className:"sl-toast-stack"}),r=class extends T{constructor(){super(...arguments),this.hasSlotController=new S(this,"icon","suffix"),this.localize=new F(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){var e;(e=this.countdownAnimation)==null||e.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){var e;this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),(e=this.countdownAnimation)==null||e.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){const{countdownElement:e}=this,t="100%",i="0";this.countdownAnimation=e.animate([{width:t},{width:i}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.duration<1/0&&this.restartAutoHide(),await v(this.base),this.base.hidden=!1;const{keyframes:e,options:t}=f(this,"alert.show",{dir:this.localize.dir()});await g(this.base,e,t),this.emit("sl-after-show")}else{this.emit("sl-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await v(this.base);const{keyframes:e,options:t}=f(this,"alert.hide",{dir:this.localize.dir()});await g(this.base,e,t),this.base.hidden=!0,this.emit("sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,b(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,b(this,"sl-after-hide")}async toast(){return new Promise(e=>{this.handleCountdownChange(),l.parentElement===null&&document.body.append(l),l.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("sl-after-hide",()=>{l.removeChild(this),e(),l.querySelector("sl-alert")===null&&l.remove()},{once:!0})})}render(){return d`
    ...
    `}};r.styles=[w,W];r.dependencies={"sl-icon-button":B};o([y('[part~="base"]')],r.prototype,"base",2);o([y(".alert__countdown-elapsed")],r.prototype,"countdownElement",2);o([n({type:Boolean,reflect:!0})],r.prototype,"open",2);o([n({type:Boolean,reflect:!0})],r.prototype,"closable",2);o([n({reflect:!0})],r.prototype,"variant",2);o([n({type:Number})],r.prototype,"duration",2);o([n({type:String,reflect:!0})],r.prototype,"countdown",2);o([L()],r.prototype,"remainingTime",2);o([C("open",{waitUntilFirstUpdate:!0})],r.prototype,"handleOpenChange",1);o([C("duration")],r.prototype,"handleDurationChange",1);x("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});x("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});r.define("sl-alert");var X=_`
  :host {
    ...
    `}};k.styles=[w,X];k.define("sl-card");var G=Object.defineProperty,J=Object.getOwnPropertyDescriptor,$=(e,t,i,s)=>{for(var a=s>1?void 0:s?J(t,i):t,h=e.length-1,u;h>=0;h--)(u=e[h])&&(a=(s?u(t,i,a):u(a))||a);return s&&a&&G(t,i,a),a};let c=class extends H(I){async createProfile(e){try{await this.store.client.createProfile(e),this.dispatchEvent(new CustomEvent("profile-created",{detail:{profile:e},bubbles:!0,composed:!0}))}catch(t){console.error(t),N(p("Error creating the profile"))}}render(){return d`
      <sl-card>
        <div class="column">
          ...
          ></edit-profile></div
      ></sl-card>
    `}};c.styles=A;$([P({context:z,subscribe:!0}),n()],c.prototype,"store",2);c=$([q(),E("create-profile")],c);const ee=Object.freeze(Object.defineProperty({__proto__:null,get CreateProfile(){return c}},Symbol.toStringTag,{value:"Module"}));export{N as a,ee as c,U as n};
