import{i as _,x as n,r as I}from"./lit-element.DlPO3IHk.js";import{n as s,S as A,s as H,c as z,p as P,t as E}from"./context.DjmyCDNo.js";import{d as w,_ as a,e as y,r as O,i as C,s as x,f as T,L as D,j as v,k as f,n as g,o as b,g as m,a as p,l as j}from"./chunk.3EPZX5HE.BXys8FbU.js";import{n as F}from"./edit-profile.C8-9731P.js";import{S as L}from"./chunk.3HB7VQL2.OEG-58U8.js";import{H as k}from"./chunk.5KGB34TL.B0QFkn-N.js";import"./range.CRHiLbae.js";import"./commonjsHelpers.D6yTTuv9.js";import"./toFinite.CFYyTVp8.js";import"./isSymbol.DnU6SLKZ.js";import"./static.BJ1mINyk.js";import"./if-defined.DksOYQzp.js";var B=_`
  :host {
    display: contents;
...
`,S=class extends T{constructor(){super(...arguments),this.hasSlotController=new k(this,"footer","header","image")}render(){return n`
    ...
    `}};S.styles=[w,U];S.define("sl-card");var q=Object.defineProperty,N=Object.getOwnPropertyDescriptor,$=(e,t,l,d)=>{for(var o=d>1?void 0:d?N(t,l):t,h=e.length-1,u;h>=0;h--)(u=e[h])&&(o=(d?u(t,l,o):u(o))||o);return d&&o&&q(t,l,o),o};let c=class extends A(I){async createProfile(e){try{await this.store.client.createProfile(e),this.dispatchEvent(new CustomEvent("profile-created",{detail:{profile:e},bubbles:!0,composed:!0}))}catch(t){console.error(t),F(p("Error creating the profile"))}}render(){return n`
      <sl-card>
        <div class="column">
          <span
            class="title"
