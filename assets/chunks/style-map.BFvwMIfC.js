import{f as C,e as k,i as $,x,r as I,T as B}from"./lit-element.CPJkn-Wj.js";import{d as O,_ as R,f as E,g as T,e as H,r as q,l as U,a as F,p as D,q as G,t as L}from"./chunk.3EPZX5HE.C1srMtB5.js";import{n as f,t as N}from"./context.mFPcU32w.js";import"./display-error.D_SbPTj7.js";function W(e){return{attribute:e,type:Object,hasChanged:(t,s)=>(t==null?void 0:t.toString())!==(s==null?void 0:s.toString()),converter:{fromAttribute:t=>t&&t.length>0&&C(t),toAttribute:t=>t&&k(t)},reflect:!0}}function ot(e){return{attribute:e,type:Object,hasChanged:(t,s)=>(t==null?void 0:t.toString())!==(s==null?void 0:s.toString()),converter:{fromAttribute:t=>t?t.split(",").map(C):[],toAttribute:t=>t&&t.map(k).join(",")},reflect:!0}}var Z=$`
  :host {
