import{m as f,s as h,c as u,l as g}from"./routes.CkF5Gd-V.js";import{a as c}from"./style-map.DgzVTwIW.js";import"./display-error.BU3R3_jK.js";import{x as o,r as m}from"./lit-element.Boh-YGZU.js";import{S as v,n as d,p as y,t as b}from"./context.CPoyaPMH.js";import"./agent-avatar.DyMJZmJT.js";import"./range.CRHiLbae.js";import"./commonjsHelpers.D6yTTuv9.js";import"./toFinite.CFYyTVp8.js";import"./isSymbol.DnU6SLKZ.js";var x=Object.defineProperty,P=Object.getOwnPropertyDescriptor,a=(e,t,r,i)=>{for(var s=i>1?void 0:i?P(t,r):t,n=e.length-1,p;n>=0;n--)(p=e[n])&&(s=(i?p(t,r,s):p(s))||s);return i&&s&&x(t,r,s),s};let l=class extends v(m){getAdditionalFields(e){const t={};for(const[r,i]of Object.entries(e.fields))r!=="avatar"&&(t[r]=i);return t}profile(){if(this.profileHash)return this.store.profiles.get(this.profileHash).latestVersion.get();if(this.agentPubKey){const e=this.store.profileForAgent.get(this.agentPubKey).get();return e.status!=="completed"?e:e.value===void 0?{status:"completed",value:void 0}:e.value.latestVersion.get()}else throw new Error("Either agentPubKey or profileHash needs to be defined for the agent-avatar element")}renderAdditionalField(e,t){return o`
		...
		`:o`<div
			...
			>
				...
				`;case"completed":return this.renderProfile(e.value);case"error":return o`<display-error
					...
					.error=${e.error}
				></display-error>`}}};l.styles=[h];a([d(c("agent-pub-key"))],l.prototype,"agentPubKey",2);a([d(c("profile-hash"))],l.prototype,"profileHash",2);a([u({context:y,subscribe:!0}),d()],l.prototype,"store",2);l=a([g(),b("profile-detail")],l);export{l as ProfileDetail};
