import{S as h,s as u,n as d,c as g,p as m,t as v}from"./context.DzK0tg0I.js";import{m as f,l as y}from"./chunk.AJ3ENQ5C.9SmIBWW5.js";import"./holo-identicon.DsBMJyu4.js";import{h as c}from"./style-map.Co6E1u6x.js";import"./display-error.BiYNJWRJ.js";import{x as o,r as b}from"./lit-element.DEsU9Zn3.js";import"./agent-avatar.BglyvhJH.js";import"./range.CRHiLbae.js";import"./commonjsHelpers.D6yTTuv9.js";import"./toFinite.CFYyTVp8.js";import"./isSymbol.DnU6SLKZ.js";var x=Object.defineProperty,P=Object.getOwnPropertyDescriptor,a=(e,t,r,i)=>{for(var s=i>1?void 0:i?P(t,r):t,n=e.length-1,p;n>=0;n--)(p=e[n])&&(s=(i?p(t,r,s):p(s))||s);return i&&s&&x(t,r,s),s};let l=class extends h(b){getAdditionalFields(e){const t={};for(const[r,i]of Object.entries(e.fields))r!=="avatar"&&(t[r]=i);return t}profile(){if(this.profileHash)return this.store.profiles.get(this.profileHash).latestVersion.get();if(this.agentPubKey){const e=this.store.profileForAgent.get(this.agentPubKey).get();return e.status!=="completed"?e:e.value===void 0?{status:"completed",value:void 0}:e.value.latestVersion.get()}else throw new Error("Either agentPubKey or profileHash needs to be defined for the agent-avatar element")}renderAdditionalField(e,t){return o`
		...
		`:o`<div
			...
			>
				...
				`;case"completed":return this.renderProfile(e.value);case"error":return o`<display-error
					...
					.error=${e.error}
				></display-error>`}}};l.styles=[u];a([d(c("agent-pub-key"))],l.prototype,"agentPubKey",2);a([d(c("profile-hash"))],l.prototype,"profileHash",2);a([g({context:m,subscribe:!0}),d()],l.prototype,"store",2);l=a([y(),v("profile-detail")],l);export{l as ProfileDetail};
